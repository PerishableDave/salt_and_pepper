defmodule SaltAndPepper.Service.APNS.PayloadTest do
  ...
  test "serializes to JSON" do
    payload =  %Payload{alert: "A Notification", badge: 0, sound: "pop.aiff", content_available: 0, category: "TEST"}
    serialized_payload= Payload.serialize(payload)
    
    map = %{"alert" => "A Notification", "badge" => 0, "sound" => "pop.aiff", "content-available" => 0, "category" => "TEST"}
